...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] artistic-theme artistic-bg flex items-center justify-center p-4 relative overflow-hidden">
      {/* 霓虹背景效果 */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#b026ff]/20 rounded-full blur-[128px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#00f0ff]/20 rounded-full blur-[128px] pointer-events-none" />
