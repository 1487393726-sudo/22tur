...
/**
 * 下载购买质量证书
 * GET /api/purchases/[id]/quality-certificate
 */
export async function GET(
  ...
  try {
    ...
    // 生成质量证书内容
    const certificateContent = generateQualityCertificate(purchase);

    // 返回HTML格式的质量证书
    return new NextResponse(certificateContent, {
      headers: {
        'Content-Type': 'text/html; charset=utf-8',
        'Content-Disposition': `attachment; filename="purchase-quality-certificate-${purchase.id}.html"`,
      },
    });
  } catch (error) {
 ...
 * 生成质量证书HTML内容
 */
function generateQualityCertificate(purchase: any): string {
  ...
  const certificateNumber = `QC-${purchase.id.substring(0, 8).toUpperCase()}-${new Date().getFullYear()}`;
...
<body>
    <div class="certificate">
        ...
        <div class="content">
            ...
            <div class="content-row">
                <div class="content-item">
                    ...
                    <div class="value">${purchase.service.title}</div>
                </div>
                <div class="content-item">
        ...
        <div class="quality-metrics">
            <div class="metrics-title">服务质量指标</div>
            <div class="metric-item">
                <span class="metric-label">服务评级：</span>
            ...
            <div class="metric-item">
                <span class="metric-label">按时交付率：</span>
                <span class="metric-value">100%</span>
            </div>
            <div class="metric-item">
                <span class="metric-label">技术支持：</span>
        ...
        <div class="verification-section">
            ...
            <div class="verification-items">
                <div class="verification-item">
                    ...
                    <div class="verification-text">质量认证</div>
                </div>
                <div class="verification-item">
                    <div class="verification-icon">✓</div>
                    <div class="verification-text">服务认证</div>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <p>本证书证明该服务已通过质量评估和合规审查</p>
            <p>This certificate confirms that the service has passed quality assessment and compliance review</p>
